...
html = html.replaceAll('{{intro_1}}', "${country.country} is an important YouTube advertising market.");
html = html.replaceAll('{{intro_2}}', "Creators targeting ${country.country} can earn strong CPM depending on niche.");

html = html.replaceAll('{{million_views_income}}', "Estimated earnings: ${country.avg_cpm} per 1,000 monetized views.");
...
html = html.replaceAll('{{faq_1_q}}', "Is ${country.country} a high CPM country?");
html = html.replaceAll('{{faq_1_a}}', "Yes, ${country.country} can offer strong CPM depending on niche.");

html = html.replaceAll('{{faq_2_q}}', "How much does 100,000 views pay in ${country.country}?");
html = html.replaceAll('{{faq_2_a}}', "Earnings vary by niche and audience quality.");

html = html.replaceAll('{{faq_3_q}}', "Which niches pay most in ${country.country}?");
html = html.replaceAll('{{faq_3_a}}', "Finance, software and business niches usually pay the most.");

html = html.replaceAll('{{related_links}}', `

<li><a href=" ">YouTube CPM USA</a ></li>
